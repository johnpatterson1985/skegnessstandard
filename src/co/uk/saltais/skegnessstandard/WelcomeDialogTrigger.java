...
public class WelcomeDialogTrigger extends Activity{
    private static final String TAG = "What's New AlertDialog Opened";
    ...
    public WelcomeDialogTrigger(Context context) {
        this(context, PreferenceManager.getDefaultSharedPreferences(context));
    }
        
    
    public WelcomeDialogTrigger(Context context, SharedPreferences sp) {
    ...
    public AlertDialog getFullWelcomeDialog() {
